...
OUT=${ROOT}/paper_results/external_baselines/marksman_port_main18_pr005
LOG=${ROOT}/logs_external_baselines/marksman_port_main18_pr005
STATUS=${OUT}/marksman_port_main18_pr005_status.csv
...
for SEED in 0 1 2; do
  run_one cifar10  resnet18 0.05 "$SEED"
  run_one cifar10  vgg11    0.05 "$SEED"
  run_one cifar100 resnet18 0.05 "$SEED"
  run_one cifar100 vgg11    0.05 "$SEED"
  run_one gtsrb    resnet18 0.05 "$SEED"
  run_one gtsrb    vgg11    0.05 "$SEED"
done
