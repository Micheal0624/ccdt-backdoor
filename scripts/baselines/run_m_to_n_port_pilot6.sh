...
OUT=${ROOT}/paper_results/external_baselines/m_to_n_port_pilot6
LOG=${ROOT}/logs_external_baselines/m_to_n_port_pilot6
STATUS=${OUT}/m_to_n_port_pilot6_status.csv
...
run_one () {
  ...
  TAG="m_to_n_port_${DATASET}_${MODEL}_pr005_seed${SEED}"
  RUN_OUT="${OUT}/${TAG}"
